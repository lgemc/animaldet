...
from animaldet.engine.registry import TRAINER_BUILDERS, INFERENCE_BUILDERS, HOOKS, MODELS, OPTIMIZERS
...
# Import optimizer builders to trigger registration
from animaldet.engine import optimizers  # noqa: F401
